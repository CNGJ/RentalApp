...
const InputGuests: FC<IGuetsProps> = ({ state, setstate }) => {
            ...
            <div>
              {Guests.map((v, i) => (
                <WrapperCounter key={i}>
                  ...
                  <CounterButtons>
                    <CounterButton type="button" disabled={v.disabled_sub} onClick={() => v.setState(v.key, '-')}>
                      -
                    </CounterButton>
                    <CounterButton type="button" onClick={() => v.setState(v.key, '+')} plus>
                      +
                    </CounterButton>
                  </CounterButtons>
                </WrapperCounter>
